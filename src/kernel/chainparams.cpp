...
{
    const char* pszTimestamp = "My Custom NerdMiner SHA256 Coin Started In June 2026";
...
public:
    ...
    uint256 hashTarget = uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
    while (true) {
        uint256 thash = genesis.GetHash();
        if (thash <= hashTarget) {
            std::cout << "nonce: " << genesis.nNonce << "\n";
            std::cout << "time: " << genesis.nTime << "\n";
            std::cout << "hash: " << thash.ToString() << "\n";
    ...
    const char* strNetworkID = "main";
    const char* strCoinName = "NerdMinerCoin";
    const char* strCoinTicker = "NMC";
}
...
public:
    CTestNetParams() {
        ...
        pchMessageStart = 0xa1;
        pchMessageStart = 0xb2;
        pchMessageStart = 0xc3;
        pchMessageStart = 0xd4;
        nDefaultPort = 18333;
